...
<div class="card">
    ...
    <div class="card-body">
        <form action="index.php?action=courses&method=edit&id=<?php echo $this->course->id; ?>" method="post">
            <div class="mb-3">
                <label for="code" class="form-label">Kode Mata Kuliah</label>
                <input type="text" class="form-control" id="code" name="code" value="<?php echo $this->course->code; ?>" required>
            </div>
            
            <div class="mb-3">
                <label for="name" class="form-label">Nama Mata Kuliah</label>
                <input type="text" class="form-control" id="name" name="name" value="<?php echo $this->course->name; ?>" required>
            </div>
            
            <div class="mb-3">
                <label for="credits" class="form-label">Jumlah SKS</label>
                <input type="number" class="form-control" id="credits" name="credits" min="1" max="6" value="<?php echo $this->course->credits; ?>" required>
            </div>
